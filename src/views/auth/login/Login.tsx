      ...
      <MDBRow>
        ...
        <MDBCol className='first-row' sm='6'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
            ...
            <MDBBtn className="mb-4 px-5 mx-5 w-100 button-login" size='lg'>Login</MDBBtn>
            <p className="small mb-5 pb-lg-3 ms-5"><a className="text-muted" href="#!">Mot de passe oublié?</a></p>
            <p className='ms-5 forgot'>Vous n'avez pas de compte? <a href="#!" className="link-infos">S'inscrire</a></p>
